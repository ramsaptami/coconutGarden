...
export const BriefcaseIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.15v4.073a2.25 2.25 0 0 1-2.25 2.25h-12a2.25 2.25 0 0 1-2.25-2.25V14.15M16.5 8.25h-9m9 0a2.25 2.25 0 0 0-2.25-2.25h-4.5A2.25 2.25 0 0 0 7.5 8.25m9 0v3.75m-9-3.75v3.75m0-3.75C7.5 8.25 7.5 7.5 7.5 7.5S7.5 8.25 7.5 8.25m9 0c0 0 0 .75 0 .75s0-.75 0-.75M3.75 9h16.5M3.75 9v3.75" />
  </svg>
);
...
export const ShieldExclamationIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m0-10.036A11.956 11.956 0 0121.982 12c0 .297-.024.59-.071.875M21.982 12a11.956 11.956 0 00-11.982-11.982A11.956 11.956 0 002.018 12c0 .297.024.59.071.875m19.891 0A11.956 11.956 0 0112 21.982a11.956 11.956 0 01-11.982-11.982A11.956 11.956 0 0112 2.018M12 15.75h.008v.008H12v-.008z" />
  </svg>
);

export const UsersIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-3.741-1.066M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 9.75a3 3 0 11-6 0 3 3 0 016 0zM12 12.75a2.25 2.25 0 012.25-.25A2.25 2.25 0 0116.5 15M12 12.75a2.25 2.25 0 00-2.25-.25A2.25 2.25 0 007.5 15M12 12.75V15m0 3V12.75" />
  </svg>
);

export const CurrencyDollarIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 11.219 12.768 11 12 11c-.768 0-1.536.219-2.121.659L9 12.036m-3 2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 14.219 12.768 14 12 14c-.768 0-1.536.219-2.121.659L9 15.036M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
  </svg>
);