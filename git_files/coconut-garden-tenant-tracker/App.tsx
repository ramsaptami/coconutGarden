      ...
      if (err instanceof Error) {
        displayError = err.message;
         if (err.message.includes('Failed to fetch') || err.message.includes('NetworkError')) {
            displayError += " (Hint: Could not connect to the backend. Please verify your Supabase URL in 'services/api.ts', your internet connection, and that your Supabase project is running.)";
            ...
            displayError += " (Hint: Authorization error. Ensure your Supabase URL and Anon Key in 'services/api.ts' are correct and that RLS policies allow access.)";
        }
      }
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        if (err.message.toLowerCase().includes('violates foreign key constraint')) {
          ...
          displayError += " (Hint: Check your Supabase Row Level Security (RLS) policies for DELETE operations on the 'tenants' table. Also, ensure your Supabase URL and Anon Key in 'services/api.ts' are correct for your project.)";
        } else if (err.message.includes('Failed to fetch') || err.message.includes('NetworkError')) {
            displayError += " (Hint: Could not connect to the backend. Please verify your Supabase URL in 'services/api.ts' and your internet connection.)";
        }
      }
